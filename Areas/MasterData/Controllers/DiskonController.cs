...
namespace NoiPurchasingSystem.Areas.MasterData.Controllers
{
    ...
    public class DiskonController : Controller
    {
        ...
        public async Task<IActionResult> DetailDiskon(Guid Id)
        {
            ...
            DiskonViewModel viewModel = new DiskonViewModel
            {
        ...
        //[Authorize(Roles = "DetailDiskon")]
        [AllowAnonymous]
        public async Task<IActionResult> DetailDiskon(DiskonViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> DeleteDiskon(Guid Id)
        {
            ...
            DiskonViewModel vm = new DiskonViewModel
            {
                DiskonId = Diskon.DiskonId,
                KodeDiskon = Diskon.KodeDiskon,
                Nilai = Diskon.Nilai
        ...
        //[Authorize(Roles = "DeleteDiskon")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteDiskon(DiskonViewModel vm)
        {
