...
namespace NoiPurchasingSystem.Areas.MasterData.Controllers
{
    ...
    public class MekanikController : Controller
    {
        ...
        public async Task<IActionResult> DetailMekanik(Guid Id)
        {
            ...
            MekanikViewModel viewModel = new MekanikViewModel
            {
        ...
        //[Authorize(Roles = "DetailMekanik")]
        [AllowAnonymous]
        public async Task<IActionResult> DetailMekanik(MekanikViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> DeleteMekanik(Guid Id)
        {
            ...
            MekanikViewModel vm = new MekanikViewModel
            {
                MekanikId = Mekanik.MekanikId,
                KodeMekanik = Mekanik.KodeMekanik,
                NamaMekanik = Mekanik.NamaMekanik,
        ...
        //[Authorize(Roles = "DeleteMekanik")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteMekanik(MekanikViewModel vm)
        {
            //Hapus Data
