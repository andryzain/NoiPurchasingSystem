...
namespace NoiPurchasingSystem.Areas.MasterData.Controllers
{
    ...
    public class SatuanController : Controller
    {
        ...
        public async Task<IActionResult> DetailSatuan(Guid Id)
        {
            ...
            SatuanViewModel viewModel = new SatuanViewModel
            {
        ...
        //[Authorize(Roles = "DetailSatuan")]
        [AllowAnonymous]
        public async Task<IActionResult> DetailSatuan(SatuanViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> DeleteSatuan(Guid Id)
        {
            ...
            SatuanViewModel vm = new SatuanViewModel
            {
                SatuanId = Satuan.SatuanId,
                KodeSatuan = Satuan.KodeSatuan,
                NamaSatuan = Satuan.NamaSatuan
        ...
        //[Authorize(Roles = "DeleteSatuan")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteSatuan(SatuanViewModel vm)
        {
