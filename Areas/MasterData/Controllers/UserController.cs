...
namespace NoiPurchasingSystem.Areas.MasterData.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            ViewBag.LevelPengguna = new SelectList(await _levelUserRepository.GetLevelUsers(), "LevelId", "NamaLevel", SortOrder.Ascending);
        ...
        public async Task<IActionResult> CreateUser(PenggunaViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {                    
                    KodeUser = vm.KodePengguna,
                    NamaUser = vm.NamaLengkap,
                    LevelId = vm.LevelId,
                    Email = vm.Email,
                    UserName = vm.Email
                };
        ...
        public async Task<IActionResult> DetailUser(Guid Id)
        {
            ...
            PenggunaViewModel viewModel = new PenggunaViewModel
            {
        ...
        //[Authorize(Roles = "DetailPengguna")]
        [AllowAnonymous]
        public async Task<IActionResult> DetailUser(PenggunaViewModel viewModel)
        {
            ViewBag.LevelPengguna = new SelectList(await _levelUserRepository.GetLevelUsers(), "LevelId", "NamaLevel", SortOrder.Ascending);
        ...
        public async Task<IActionResult> DeleteUser(Guid Id)
        {
            ...
            PenggunaViewModel vm = new PenggunaViewModel
            {
                PenggunaId = pengguna.PenggunaId,
                KodePengguna = pengguna.KodePengguna,
                NamaLengkap = pengguna.NamaLengkap,
        ...
        //[Authorize(Roles = "DeletePengguna")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteUser(PenggunaViewModel vm)
        {
            //Hapus Akun Login
            var akunpengguna = _signInManager.UserManager.Users.FirstOrDefault(s => s.KodeUser == vm.KodePengguna);
